...
public class CustomExceptioHandler extends ResponseEntityExceptionHandler{
	...
	public final ResponseEntity<Object> handUserNotFoundException(UserNotFoundException ex, WebRequest request){
		 ...
		 List<String> details = new ArrayList<>();
	          //details.add(ex);
	        ErrorResponse error = new ErrorResponse("Such Username not exist",HttpStatus.NOT_FOUND, details);
    ...
    public final ResponseEntity<Object> handleUserNotFoundException(ExpiredJwtException ex, WebRequest request) {
        ...
        ErrorResponse error = new ErrorResponse("RECORD NOT AVIALABLE",HttpStatus.NOT_FOUND, details);
        return new ResponseEntity(error, HttpStatus.NOT_FOUND);
    }
	
	/*
	 * @ExceptionHandler(value = ExpiredJwtException.class) public
	 * ResponseEntity<Object> exception(ExpiredJwtException exception) {
	 * System.out.println(":::::CustomExceptioHandler::::::"); return new
	 * ResponseEntity<>("TOKEN IS EXPIRED", HttpStatus.ALREADY_REPORTED); }
	 */
